...
#    collection_manager.add_collection(Collection("Album 1", "Album", ["001", "002"], collection_manager.conn))
#    collection_manager.add_collection(Collection("Compilation 1", "Compilation", ["001", "002"], collection_manager.conn))
